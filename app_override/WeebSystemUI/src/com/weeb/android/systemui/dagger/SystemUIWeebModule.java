...
public abstract class SystemUIWeebModule {
    ...
    @Binds
    abstract ThemeOverlayController provideThemeOverlayController(ThemeOverlayControllerWeeb themeOverlayController);
}
